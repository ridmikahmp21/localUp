          ...
          <div className="max-w-4xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Share events, workshops, and connect with other buyers and
                sellers
              </p>
            </div>
                  ...
                  <div className="px-5 py-2 flex justify-between">
                    ...
                    >
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M极.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z"
                          clipRule="evenodd"
                        />
                      </svg>
                      <span>Like</span>
                    ...
                    <button className="flex items-center space-x-2 px-4 py-2 text-gray-600 rounded-lg hover:bg-gray-100">
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M18 5v8a2 2 0 01-2 2h-5l-5 4v-4H4a2 2 0 01-2-2V5a2 2 0 012-2h12a2 2 0 012 2zM7 8H5v2h2V8zm2 0h2v2H9极8zm6 0h-2v2h2V8z"
                          clipRule="evenodd"
                        />
                      </svg>
                      <span>Comment</span>
                    ...
                    <button className="flex items-center space-x-2 px-4 py-2 text-gray-600 rounded-lg hover:bg-gray-100">
                      <svg
                        ...
                        fill="currentColor"
                      >
                        <path d="M15 8a3 3 0 10-2.977-2.63l-4.94 极.47a3 3 0 100 4.319l4.94 2.47a3 3 极 10.895-1.789l-4.94-2.47a3.027 3.027 0 000-.74l4.94-2.47C13.456 7.68 14.19 8 15 8z" />
                      </svg>
                      <span>Share</span>
                    </button>
                  </div>
